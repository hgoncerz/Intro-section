...
import "../scss/dropDownFeatures/dropDownFeatures.scss";
...
const DropDownFeatures: React.FC<Props> = ({ isOpen, setIsOpen }) => {
  return (
    <div className="dropDownFeature">
      <a
        href="#"
        style={{ display: "flex" }}
        onClick={() => {
      ...
      {!isOpen && (
        <div className="dropDownFeature__list">
          <ul>
            <li>
              <a href="#">
